<nav class="bg-main-color mt-2 mx-2 rounded-md shadow-sm">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <p class="text-white text-capitalize text-lg font-semibold tracking-widest uppercase rounded-lg focus:outline-none focus:shadow-outline">{{Auth::user()->name}}'s Profile</p>
          </div>
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <a href="{{ROUTE('getprofile')}}" class="text-white   px-3 py-2 rounded-md text-sm font-medium">Profile</a>

              <a href="{{route('User.gallery')}}" class="text-white px-3 py-2 rounded-md text-sm font-medium">Gallery</a>
          ...
          <div class="ml-3 relative">
            <div>
              <button type="button"  onclick="toggle()"  class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"  aria-expanded="false" aria-haspopup="true">
                ...
                <img class="h-8 w-8 rounded-full" src="{{ asset('uploads')}}/{{Auth::user()->image}}" alt="">
              </button>
            </div>
