                        ...
                        <div class="flex row">
                           ...
                           <div class="m-2 row">
                              <div class="card" style="width: 22rem; m-2">
                                  ...
                                  <img class="card-img-top "  alt=" user-image" @if($item['image'] ==NULL)src="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80"
                                  @else
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="d-flex">
                                     ...
                                     @endif
                                     @if($item->mothertongue_id !=NULL)
                                     <p class="ml-auto"> {{$item->mothertongue->name}}</p>
                         ...
                         @endif
                                    ...
                                    <p>{{$item->country->name}} ,{{$item->state->name}}
                                    </p>
                                   ...
                                   <p class=""> prefrence:{{$item->prefrence}}</p>
                                    @endif
                                  ...
                                  <div class="card-footer d-flex">
                                    <small class="text-muted"> <form    id="Profile_like" class="like" data-id="{{$item->id}}" >
                                        ...
                                        <button class="bg-transparent border-0 text-primary cursor-pointer" type="submit" id="like-btn" >
                                        ...
                                        @else
                                        <button class="bg-transparent border-0 text-primary  cursor-pointer" type="submit" data-stat="unlike" id="dislike-btn">
                                    ...
                                    <div class="ml-auto mt-1">
                                            ...
                                            <a href="Profile/detail/{{$item->id}}">view profile</a>
