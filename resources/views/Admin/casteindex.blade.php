...
<body>
  ...
  <div x-show="open" x-ref="userMenu"
            ...
            <div class="mt-2">
                ...
                <div class="modal" id="modal">
                    <div id="pop" class="pop">
                        <h1 class="  dark:text-dark"> add a new caste</h1>
                            <i class="fa fa-times  text-dark" aria-hidden="true"  id="close"></i>
                            <form method="POST" action="{{route('admin.casteinsert')}}">
                                @csrf
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter the caste" required>
      ...
      <td data-column="name" class="dark:text-dark ">    {{$item['name']}}</td>
                        ...
                        <td data-column="delete" id="delete"><a href="/admin/caste/delete/{{$item['id']}}"><i
                                    class="far fa-trash-alt" style="color:red"></i></a></td>
                        <td data-column="change status"><a href="/admin/caste/status/{{$item['id']}}"> change status</a>
                        </td>
                    </tr>
                    <tr>
