...
<x-mobilesidebar/>                   
                ...
                <main>
                    ...
                    <div id="pop">
                        <h1 class="dark:text-dark"> add a new Occupation</h1>
                            <i class="fa fa-times dark:text-dark" aria-hidden="true" id="close"></i>
                            <form method="POST" action="{{route('admin.Occupationinsert')}}">
                                @csrf
...
<table class="shadow-lg">
  ...
  @foreach($data as $key=>$item)
    <tr>
      ...
      <td data-column="delete" id="delete"><a href="/admin/Occupation/delete/{{$item['id']}}"><i class="far fa-trash-alt"style="color:red"></i></a></td>
      <td data-column="change status"><a href="/admin/Occupation/status/{{$item['id']}}"> change status</a></td>
    </tr>
    <tr>
