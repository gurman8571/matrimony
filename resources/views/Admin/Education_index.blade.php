...
<x-mobilesidebar/>
                ...
                <main>
                    ...
                    <div id="pop">
                        <h1 class="dark:text-dark"> add a new Education</h1>
                            <i class="fa fa-times dark:text-dark" aria-hidden="true" id="close"></i>
                            <form method="POST" action="{{route('admin.Educationinsert')}}">
                                @csrf
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter the Eduaction" required>
...
<table class="shadow-lg">
  ...
  @foreach($data as $key=>$item)
    <tr>
      ...
      <td data-column="delete" id="delete"><a href="/admin/Education/delete/{{$item['id']}}"><i class="far fa-trash-alt"style="color:red"></i></a></td>
    </tr>
    <tr>
    ...
    <script>
     ...
     //console.log(button);
         $.ajax({
             type: "GET",
             dataType: "json",
             url: "{{route('admin.Educationstatus')}}",
             data: { 'id': id},
