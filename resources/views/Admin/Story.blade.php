...
<body>
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden'); setColors(color);" :class="{ 'dark': isDark}">
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            <!---modal-->
            <div class="  hidden preview" id="modal">
                <div class=" hidden pop2">
                        <i class="fa fa-times  text-dark" aria-hidden="true"  id="close"></i>
  ...
  <div x-show="open" x-ref="userMenu"
        ...
        <main>
            ...
            <table class="shadow-lg">
                <thead class="dark:text-primary-light">

                    <tr>
                        <th class=" bg-primary-light">Bride</th>

                        <th class=" bg-primary-light">Groom</th>


      <th class=" bg-primary-light">Preview</th>
      <th class=" bg-primary-light">status</th>
      <th class=" bg-primary-light">delete</th>


      <th class=" bg-primary-light">change Display Control</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($stories as $key=>$item)
                    <tr>
                    <td data-column="bride" class="dark:text-dark ">{{$item['bride']}}</td>
      <td data-column="groom" class="dark:text-dark ">    {{$item['groom']}}</td>
      <td data-column="preview" class=" text-blue-800 dark:text-dark ">  <a href="{{route('User.story.Preview',[$item->id])}}"> <i class="fas fa-eye"></i></a></td>

      <td data-column="on Display" class="dark:text-dark "> @if($item->ondisplay==1)
 ...
 @else
 <span class="inline-block px-2 py-1 leading-none  text-blue-800 bg-orange-400 rounded-full font-semibold uppercase tracking-wide text-xs">not on display</span>

 @endif

</td>
                        <td data-column="delete" ><a href="{{route('Admin.stories.delete',[$item->id])}}"><i
                                    class="far fa-trash-alt" style="color:red"></i></a></td>
                        <td data-column="change status"><a href="{{route('User.story.displaystatus',[$item->id])}}"> change</a>
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="links">{{$stories->links()}}</div>
            <br>
            <br>
