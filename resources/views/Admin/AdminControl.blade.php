...
<x-mobilesidebar/>
  ...
  @foreach($data as $key=>$item)
    ...
    <td data-column="S.no" class="dark:text-dark ">{{$item['id']}}</td>
      ...
      <td data-column="delete" id="delete"><a href="/admin/delete/{{$item['id']}}"><i class="far fa-trash-alt"style="color:red"></i></a></td>
      <td data-column="change status"><a href="/admin/status/{{$item['id']}}"> change status</a></td>
    </tr>
    <tr>
