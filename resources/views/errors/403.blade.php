      ...
      >
        <div class="p-4 space-y-4">
          <div class="flex flex-col items-start space-y-3 sm:flex-row sm:space-y-0 sm:items-center sm:space-x-3">
            <p class="font-semibold text-danger-light text-9xl dark:text-danger">403</p>
            <div class="space-y-2">
...
<div class="p-2">
    <p class="text-base font-normal text-gray-600 dark:text-gray-300">
        ...
        <a href="{{route('userprofile')}}" class="text-blue-600 hover:underline dark:text-blue-500">Profile </a> to proceed
