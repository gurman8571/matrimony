                            ...
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <a href="#" target="_blank" style="display: block; max-width: 128px;">
                                        <img src="{{asset('img/logo.png')}}" alt="logo.png" border="0"
                                             style="display: block; "/>
                                    </a>
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                        ...
                                        <span
                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Thank You!</span>
                                    </font>
                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#585858"
                                          style="font-size: 24px; line-height: 32px;">
                                        <span
                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">Your details have reached us. A Relationship Manager will contact you soon!</span>
                                    </font>
                                    <div style="height: 20px; line-height: 20px; font-size: 18px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#585858"
                                          style="font-size: 24px; line-height: 32px;">
                                        <span
                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">We look forward to serving you</span>

                                        <div style="height: 20px; line-height: 20px; font-size: 18px;">&nbsp;</div>

                                        <span
                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">
                               Should you have any queries further, please reach us through our Customer Care</span>
                                    </font>
                                    <div style="height: 22px; line-height: 33px; font-size: 31px;">&nbsp;</div>

                                    <table style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #585858;font-size: 22px;line-height: 32px;">
                                        <tr>
                                            <td>
                                                <b>Call for any query</b><br/>Stay in touch regarding any of your query :</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <ul>
                                                    <li>matrimonnial services</li>
                                                    <li>Blog writing</li>
                                        ...
                                        <tr>
                                            <td align="center" valign="top">
                                                ...
                                                <font face="'Source Sans Pro', sans-serif" color="#868686"
                                                    ...
                                                    <span
                                                        style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 17px; line-height: 20px;">Copyright &copy; 2021 matimony &nbsp;Rights&nbsp;Reserved. We&nbsp;appreciate&nbsp;you!</span>
                                                </font>
                                                ...
                                                <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                                    ...
                                                    <span
                                                        style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px;"> &nbsp;&nbsp;|&nbsp;&nbsp; <a
                                                            href="#" target="_blank"
                                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">+91 9878125064</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a
                                                            href="#" target="_blank"
                                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;"></a></span>
                                                </font>
